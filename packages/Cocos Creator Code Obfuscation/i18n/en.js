 ...
 * @LastEditTime: 2022-12-13 10:08:05
...
module.exports = {
    ...
    'menu': {
        name: "AST Code Obfuscated ·✍",
        argu_set: "parameter · des",
        argu_param_web: "param web page",
        argu_metaUuid: "change all .meta -> UUID",
    ...
    'proj_des': {
        ...
        is_AST_obfus: {
            des: "The AST (Abstract Syntax Tree) is disabled by default to confuse the functions of JS files.<br> After the AST (Abstract Syntax Tree) is enabled,  <br> the Js file will be confused for the second time after the previous confusion is completed.  <br> This confusion will use the built-in long random number and secret key to confuse the functions irreversibly!<br>(Will completely rewrite the reference class name and function name, please use it with caution)",
            lab: "AST Obfus Js"
        },
        is_json_obfus: {
