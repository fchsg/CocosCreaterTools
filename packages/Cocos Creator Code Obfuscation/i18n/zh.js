 ...
 * @LastEditTime: 2022-12-13 10:07:47
...
module.exports = {
    ...
    'menu': {
        name: "AST 构建后混淆·✍",
        argu_set: "JS-OB 参数·介绍面板",
        argu_param_web: "JS-OB 参数·试验·WEB面板",
        argu_metaUuid: "更改所有的 .meta 文件",
        argu_des: "选择 JS ·指定混淆·面板",
        open: "✔ 开启 AST 混淆",
        close: "✘ 关闭 AST 混淆",
        open_setting_panel: "打开自定义 JS-OB 混淆数据的->介绍面板",
    ...
    'proj_des': {
        ...
        is_AST_obfus: {
            des: "默认关闭 AST (抽象语法树) 来混淆 JS 文件的功能, 开启后, <br>会在之前的混淆完成后再对 Js 文件执行第二次混淆,<br>本次混淆将会采用内置的长随机数和秘钥来对函数进行不可逆 MD5 混淆!<br>(会彻底改写引用类名函数名,使用时请谨慎使用)",
            lab: "AST 混淆 Js "
        },
        is_json_obfus: {
